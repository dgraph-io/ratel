        ...
        switch (action.type) {
            case RECEIVE_FRAME: {
                ...
                if (draft.items.length) {
                    ...
                    if (lastFrame.action === frame.action && lastFrame.query === frame.query) {
            ...
            case DISCARD_FRAME:
                draft.items = draft.items.filter((item) => item.id !== action.frameId)
                break
            ...
            case FRAME_REQUEST_ERROR: {
                ...
                Object.assign(frameResult, getFrameTiming(frameResult.executionStart, {}))
                break
            }
            ...
            case FRAME_REQUEST_COMPLETED: {
                ...
                Object.assign(
                    frameResult,
                    getFrameTiming(frameResult.executionStart, response.extensions),
                )
                break
            }
