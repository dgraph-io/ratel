...
export const loginUser = async (page, userid = "groot", password = "password") => {
    ...
    const buttons = await page.$$(".modal.server-connection .modal-body button.btn.btn-primary")
    ...
    const sidebarText = await getElementText(page, ".modal.server-connection .modal-body")
...
export const logoutUser = async (page) => {
    ...
    const btnTexts = await page.$$eval(btnLogoutSelector, (btns) => btns.map((b) => b.textContent))
