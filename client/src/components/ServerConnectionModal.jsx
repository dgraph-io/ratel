...
export default function ServerConnectionModal() {
    ...
    const isAclEnabled = !activeServer || activeServer.isAclEnabled || activeServer?.aclState !== OK
            ...
            >
                <Tab eventKey="acl" title="ACL Account">
                    {isAclEnabled ? (
                        ...
                        <em>
                            This Alpha has unrestricted access (Access Control Lists are disabled)
                        </em>
                    )}
                </Tab>
                ...
                <Tab eventKey="extra-settings" title="Extra Settings">
                    <Form.Group controlId="queryTimeoutInput">
                        ...
                        <Form.Control
                            ...
                            onChange={(e) => {
                                ...
                                if (newTimeout > 0) {
                                    dispatch(actions.setQueryTimeout(activeServer.url, newTimeout))
                                }
                            }}
                        />
                    </Form.Group>
                    <Form.Group controlId="slashApiKeyInput">
                        ...
                        <Form.Control
                            ...
                            onChange={(e) =>
                                dispatch(actions.setSlashApiKey(activeServer.url, e.target.value))
                            }
                        />
                    </Form.Group>
                </Tab>
                ...
                {serverHistory.map((s, index) => (
                    ...
                    >
                        ...
                        <p className="minor">
                            ...
                            {index === 0 && <HealthDot health={s.health} version={s.version} />}{" "}
                            {s.version}
                        </p>
                        <Button
        ...
        <Modal show={true} onHide={onHide} backdrop="static" keyboard={false}>
            ...
            <Modal.Footer>
                ...
                <Button
                    ...
                    disabled={false}
                    variant={
                        alreadyConnected && activeServer.aclState === OK ? "primary" : "secondary"
                    }
