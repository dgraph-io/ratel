...
if (env.stringified["process.env"].NODE_ENV !== '"local"') {
    throw new Error("Local builds must have NODE_ENV=local.");
}
...
module.exports = {
    ...
    // In local, we only want to load the polyfills and the app code.
                            ...
                            Object.assign(
                                {
                                    ...
                                    use: [
                                        ...
                                        },
                                        {
                                            ...
                                            options: {
                                                // Necessary for external SCSS imports to work
                                                // https://github.com/facebookincubator/create-react-app/issues/2677
                                                ident: "postcss",
                                                plugins: () => [
                                                    require("postcss-flexbugs-fixes"),
